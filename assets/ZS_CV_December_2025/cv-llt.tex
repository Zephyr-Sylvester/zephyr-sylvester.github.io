...
\mynames{Zephyr\bibnamedelima T.,
  Sylvester/Zephyr\bibnamedelima T.,
  Sylvester/Zephyr,
  Sylvester/\bibnamedelimi Z.}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Zephyr Sylvester, Ph.D.}

  \makefield{\faMapMarker*}{\texttt{Santa Cuz, CA, USA}}
  \makefield{\faEnvelope[regular]}{\href{mailto:zephyr.sylvester@colorado.edu}{\texttt{zephyr.sylvester@colorado.edu}}}
  ...
  {\href{http://www.linkedin.com/in/zephyr-sylvester/}{\texttt{LinkedIn}}}

}
% check out all icons: https://mirrors.ibiblio.org/CTAN/fonts/fontawesome5/doc/fontawesome5.pdf
